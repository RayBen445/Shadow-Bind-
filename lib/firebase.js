...
if (missingVars.length > 0) {
  ...
  console.warn('[Firebase] Using demo configuration. Some features may not work correctly.');
  console.warn('[Firebase] Please check your .env.local file and ensure all Firebase configuration values are set.');
